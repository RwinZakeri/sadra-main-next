    ...
    const fetchData = async () => {
      try {
        ...
        const responseToken3 = await axios.get(
          "http://localhost:3001/api/classes/data",
          {
            headers: {
              "x-api-key": process.env.NEXT_PUBLIC_API_ACCESS_KEY,
            },
    ...
    try {
      ...
      try {
        const response = await axios.post(
          "http://localhost:3001/api/admin/panel/classes",
          formData,
          {
            headers: {
        ...
        showToast(
          "کلاس یا دوره جدید با موفقیت ثبت شد. بعد از تایید ادمین در سایت قرار میگیرد.",
          "success"
        );
      } catch (error) {
