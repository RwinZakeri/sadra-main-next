...
// Styles
// Components
import InputContact from "../module/input_module/InputContact";
import moment from "jalali-moment";
import { showToast } from "../module/AuthModules/Toastify";
...
function ContactUsPage() {
  ...
  const sendHandler = async () => {
    ...
    try {
      if (!name || !lastName || !phoneNumber || !description) {
        showToast("لطفا تمامی فیلد هارا پر کنید.", "error");
        return;
      }
      ...
      axios
        .post(`http://localhost:3001/api/contact-us/admin/panel/contact-us`, {
          firstName: name,
          lastName: lastName,
        ...
        .then((response) => {
          showToast(
            "نظر شما ارسال شد! منتظر پاسخ از تیم پشتیبانی باشید.",
            "success"
          );
        })
        .catch((error) => {
      ...
      <div className="contactContainer">
        <div className="contactUsTexts">
          <div className="contactUsTextsHeader">
            ...
            <p>
              در صورت داشتن هر سوال و یا مشاوره ای میتوانید از مسیر ها زیر با ما
              در ارتباط باشید
            </p>
          </div>
          <div className="contactInfo">
            <div className="contactIconContainer">
              ...
              &nbsp; &nbsp;
              <span>
                تهران، میدان توحید، خیابان فرصت شیرازی، بین اسکندری و قریب، پلاک
                103، طبقه چهارم، واحد12
              </span>
            </div>
            <div className="contactIconContainer">
              <span className="contactIcon">
              ...
              &nbsp; &nbsp; &nbsp;
              <Link href={"tel:02166940883"} dir="ltr">
                ۰۲۱ - ۶۶۹۴۰۸۸۳
              </Link>
            </div>
            <div className="contactIconContainer">
              ...
              &nbsp; &nbsp; &nbsp;
              <Link
                href={"mailto:info@sadra-edu.com"}
          ...
          <div>
            <div className="contantWorkDetails">
              ...
              <p>
                اگر دوست داری با تیم صدرا همکاری کنی حتما به ما پیام بده تا در
                اولین فرصت همکاران ما با شما تماس بگیرن.
              </p>
            </div>
        ...
        >
          <Image
            width={400}
            height={400}
            src="/assets/contact/Banner image.png"
            alt="banner pic"
          />
        </div>
      </div>
