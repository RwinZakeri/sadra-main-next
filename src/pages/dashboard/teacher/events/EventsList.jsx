...
import SignOutButton from "@/components/templates/dashboard/SignOutButton";
...
import { adminCategories } from "@/components/templates/dashboard/Categories";
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        setUserId(id);
        // if (id) {
        //     axios.get(`https://sadra-edu.com/api/dashboard/blog/${id}`)
        //         .then(secondResponse => {
